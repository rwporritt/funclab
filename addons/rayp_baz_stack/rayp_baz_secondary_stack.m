function rayp_baz_secondary_stack(cbo,eventdata,handles)
% RAYP_BAZ_SECONDARY_STACK
...
%  the stack
%  Just change of eqr to eqt from Primary version...
%
...
uicontrol ('Parent',WaitGui,'Style','text','Units','characters','Tag','message_t',...
    'String','Please wait, performing ray parameter and backazimuth stacking for the secondary RFs in the dataset.',...
        ...
        for irayp=1:nrayP
            ...
            for ibaz=1:nBaz
                ...
                if ~isempty(iHits)
                    ...
                    sfnameMEAN = sprintf('STACK_%s_eqt_%03.3f_%03.3f_%03.3f_mean.SAC',CurrentRecords{1,2},CurrentRecords{1,10},tmpRayP,tmpBaz);
                    sfnameSD = sprintf('STACK_%s_eqt_%03.3f_%03.3f_%03.3f_sd.SAC',CurrentRecords{1,2},CurrentRecords{1,10},tmpRayP,tmpBaz);
                    ...
                    for istack=iHits
                        ...
                        sfname = sprintf('%s%s%seqt',ProjectDirectory,filesep,CurrentRecords{istack,1});
