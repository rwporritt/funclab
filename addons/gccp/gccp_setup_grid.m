function [binmatrix] = gccp_setup_grid(minlat,maxlat,minlon,maxlon,bspace,bsize)
%GCCP_SETUP_GRID Setup geographical binning matrix
%   GCCP_SETUP_GRID (minlat,maxlat,minlon,maxlon,bspace,bsize) sets up the
...
%
%   EXAMPLE:
%   binmatrix = gccp_setup_grid (35,48,-126,-110,100,200);
