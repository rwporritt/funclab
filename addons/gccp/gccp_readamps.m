function AMPS = gccp_readamps(SacFile)
%GCCP_READAMPS reads seismogram amplitudes from a SAC file
%   GCCP_READAMPS(SacFile) reads in a seismogram from a SAC file specified
