function out=fl_mmpolar_setcolor(varargin)
...
% Stupidly simple modification by Rob Porritt to set the color of markers
% based on the set color.
SetManagementCell = evalin('base','SetManagementCell');
CurrentSubsetIndex = evalin('base','CurrentSubsetIndex');
MarkerColor = SetManagementCell{CurrentSubsetIndex,6}/255;
