function fl_view_rf_cross_section_depth(ProjectDirectory,ProjectFile,FuncLabPreferences)
...
OutputFigureDir = [ProjectDirectory filesep 'FIGURES' filesep 'RF_Cross_Section_Depth'];
