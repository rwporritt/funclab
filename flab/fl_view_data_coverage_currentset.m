function fl_view_data_coverage_currentset(RecordMetadataDoubles)
...
fl_mmpolar_setcolor(RecordMetadataDoubles(ActiveIn,19)*pi/180,RecordMetadataDoubles(ActiveIn,18),'Style','Compass','TTickValue',[0:15:360],...
